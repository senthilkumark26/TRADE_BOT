    ...
    def __init__(self, investment_amount=30000, paper_trading=None, symbols=None):
        ...
        try:
            ...
            if self.mcx_sentiment_service.is_enabled():
                logger.info("MCX Sentiment Service initialized (optional NSE confirmation filter)")
            else:
                logger.info("MCX Sentiment Service available but disabled (enable via config)")
        except Exception as e:
        ...
        logger.info("Prop Desk Architecture ready (8 independent services + MCX sentiment filter + Watchdog)")
    ...
    def select_best_strike(self):
        ...
        for symbol in instruments:
            try:
                ...
                # ========================================
                logger.info(f"[STRIKE SELECTOR] Calling strike selector for {symbol}")
                ...
                if not self.strike_selector_service:
                    ...
                    logger.info(f"[STRIKE SELECTOR] Using professional selection for {symbol}")
