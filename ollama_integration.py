...
class OllamaIntegration:
    ...
    def __init__(self, base_url: str = "http://localhost:11434", default_model: str = "mistral:7b", prompt_file: str = "trading_prompt.txt", fast_mode: bool = False):
        """
        Initialize Ollama integration.

        Args:
            base_url: Ollama API base URL (default: http://localhost:11434)
            default_model: Default model to use (default: qwen2:7b)
            prompt_file: Path to strict trading prompt file (default: trading_prompt.txt)
